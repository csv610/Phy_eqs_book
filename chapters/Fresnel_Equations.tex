...
The derivation starts from Maxwell's boundary conditions requiring continuity of the tangential components of $\mathbf{E}$ and $\mathbf{H}$ across a planar dielectric interface.
