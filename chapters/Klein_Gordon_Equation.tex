...
The derivation starts from the relativistic energy--momentum relation $E^2 = p^2c^2 + m^2c^4$ with quantum operator substitutions $E \to i\hbar\partial_t$, $\mathbf{p} \to -i\hbar\nabla$.
