...
The derivation starts from the grand canonical partition function for a single quantum state, with the Pauli exclusion principle restricting occupation numbers to 0 or 1.
