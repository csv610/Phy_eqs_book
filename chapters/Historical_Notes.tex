...
This chapter traces the historical development of the equations in this book. Physics progresses not by sudden revelations but by cumulative insight---each equation building on centuries of observation, argument, and refinement. The dates below mark when each relation first appeared in print, though the underlying ideas often had earlier ancestors.

\begin{longtable}{p{5.5cm}p{4.5cm}p{2cm}}
...
Poisson's Equation & Sim\'eon Denis Poisson & 1813 \\
...
Mass--Energy Equivalence & Albert Einstein & 1090 \\
...
Time-Indep.\ Schr\"odinger Eq. & Erwin Schr\"odinger & 1926 \\
...
\section*{Patterns in the History}

The equations cluster into distinct eras. Classical mechanics (Kepler through Euler) dominated the 17th--18th centuries, built on geometric reasoning and the calculus Newton and Leibniz invented. Thermodynamics (Carnot, Clausius, Boltzmann) emerged in the 19th century from engineering problems---steam engines, heat engines, gas laws---and produced the profound insight that macroscopic irreversibility coexists with microscopic reversibility.

Electromagnetism (Faraday, Maxwell, Hertz) unified optics and electricity into a single field theory by 1865. The wave equation for light was not new, but Maxwell showed that light \textit{is} an electromagnetic wave. This was the first great unification in physics.

The quantum revolution (1900--1930) compressed the most productive period in physics history. Planck introduced quantization (1900), Einstein explained the photoelectric effect (1905), Bohr built his atom (1913), de Broglie proposed matter waves (1924), Schr\"odinger wrote his wave equation (1926), Heisenberg formulated matrix mechanics and uncertainty (1925--1927), and Dirac unified quantum mechanics with relativity (1928). In three decades, the classical worldview was replaced.

General relativity (1915) stood apart---Einstein's solitary genius reframing gravity as geometry. The field equations predicted black holes, gravitational waves, and an expanding universe, decades before observations confirmed any of them.

\section*{Why History Matters}

These dates are not trivia. They reveal that physics is a conversation across centuries. Newton stood on Galileo's shoulders; Maxwell stood on Faraday's; Schr\"odinger stood on de Broglie's. Each equation carries the accumulated insight of its era. Understanding when and why an equation arose helps you understand what it means and when it fails.
...
\item Pais, A., \textit{``Subtle is the Lord'': The Science and the Life of Albert Einstein} (Oxford University Press, 1982).
\item Ford, K.W., \textit{The Evolution of the Electron} (Prentice-Hall, 1968).
\end{enumerate}
