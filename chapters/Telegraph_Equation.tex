...
The derivation starts from a distributed circuit model of a transmission line with resistance $R$, inductance $L$, conductance $G$, and capacitance $C$ per unit length.
