...
The derivation starts from Liouville's theorem, which states that the phase-space distribution is constant along trajectories in the collisionless case.
