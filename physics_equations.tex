...
\usepackage{titletoc}
\usepackage{fancyhdr}
\titlecontents{chapter}[0em]{\color{blue}\bfseries\large}{}{\hspace*{1.5em}}{\titlerule*[1pc]{}.}
\titlecontents{part}[0em]{\color{blue}\bfseries\huge}{}{}{\titlerule*\rule{1em}{1pt}\quad}
...
\input{chapters/Fundamental_Equations}
...
\input{chapters/Ampere_Maxwell_Law}
\input{chapters/Bernoulli_Equation}
\input{chapters/Biot_Savart_Law}
\input{chapters/Boltzmann_Transport_Equation}
\input{chapters/Bose_Einstein_Distribution}
\input{chapters/Boundary_Layer_Equation}
\input{chapters/Carnot_Efficiency}
\input{chapters/Clausius_Clapeyron_Equation}
\input{chapters/Conservation_of_Mechanical_Energy}
\input{chapters/Continuity_Equation}
\input{chapters/Damped_and_Driven_Harmonic_Oscillator}
\input{chapters/De_Broglie_Wavelength}
\input{chapters/Diffusion_Equation}
\input{chapters/Dirac_Equation}
\input{chapters/Electromagnetic_Wave_Equation}
\input{chapters/Entropy}
\input{chapters/Euler_Bernoulli_Beam_Equation}
\input{chapters/Euler_Equation_Fluid}
\input{chapters/Euler_Lagrange_Equation}
\input{chapters/Faraday_s_Law}
\input{chapters/Fermi_Dirac_Distribution}
\input{chapters/Fraunhofer_Diffraction}
\input{chapters/Fresnel_Equations}
\input{chapters/Friedmann_Equation}
\input{chapters/Gauss_s_Law_Electricity}
\input{chapters/Gauss_s_Law_Magnetism}
\input{chapters/Geodesic_Equation}
\input{chapters/Hamilton_s_Equations}
\input{chapters/Heat_Equation}
\input{chapters/Heisenberg_Equation}
\input{chapters/Heisenberg_Uncertainty_Principle}
\input{chapters/Historical_Notes}
\input{chapters/Ideal_Gas_Equation}
\input{chapters/Kepler_s_Third_Law}
\input{chapters/Kinematic_Equations}
\input{chapters/Klein_Gordon_Equation}
\input{chapters/Laplace_s_Equation}
\input{chapters/Length_Contraction}
\input{chapters/Li_nard_Wiechert_Potentials}
\input{chapters/Lorentz_Force_Law}
\input{chapters/Mass_Energy_Equivalence}
\input{chapters/Maxwell_Boltzmann_Distribution}
\input{chapters/Maxwell_Relations}
\input{chapters/Mirror_Equation}
\input{chapters/Navier_Stokes_Equation}
\input{chapters/Partition_Function}
\input{chapters/Pauli_Equation}
\input{chapters/Planck_Radiation_Law}
\input{chapters/Plate_Equation}
\input{chapters/Poisson_s_Equation}
\input{chapters/Poynting_Theorem_Energy_Conservation_in_Electromagnetic_Fields}
\input{chapters/Probability_Current}
\input{chapters/Quantum_Continuity_Equation}
...
\input{chapters/Equation_Summary}
